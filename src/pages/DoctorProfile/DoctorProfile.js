            ...
            <>
              ...
              <div className={styles['doctor-card__details']}>
                <p className={styles['doctor-card__detail']}>
                  <span className={styles['doctor-card__detail-label']}>Опыт:</span> {doctor.experience}
                </p>
                <p className={styles['doctor-card__detail']}>
                  <span className={styles['doctor-card__detail-label']}>Образование:</span> {doctor.education}
                </p>
                <p className={styles['doctor-card__detail']}>
                  <span className={styles['doctor-card__detail-label']}>Email:</span> {doctor.email}
                </p>
                <p className={styles['doctor-card__detail']}>
                  <span className={styles['doctor-card__detail-label']}>Рейтинг:</span> {doctor.rating}/5
                </p>
              </div>
